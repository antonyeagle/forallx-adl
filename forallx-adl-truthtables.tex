...
This table summarises what is required to directly construct valuations demonstrating the presence of absence of various semantic notions:
\begin{center}
...
%\cline{2-3}
 ...
 \midrule
%\cline{2-3}
tautology? & all valuations: complete truth table & one valuation: one-line partial truth table\\
...
This procedure works because our partial truth table test is guaranteed to succeed in demonstrating the absence of validity, for an invalid argument. Accordingly, if our test fails to demonstrate the absence of validity, that must be because the argument is in fact valid. 
