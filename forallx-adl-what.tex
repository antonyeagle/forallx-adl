...
\begin{earg}
	...
	\item[So:] \meta{B}.
\end{earg}
Any argument with this sort of structure will be conclusive in virtue of structure, and hence valid. It does not matter, really, what sentences we put in place of `\meta{A}' and `\meta{B}'. (It matters a bit: you can't put a question or an exclamation and get a valid argument.) 
