...
\item[] Sarah is diligent and hardworking.
...
\problempart A feature of a set $A$ is \define{monotonic} if any set including $A$ also has the feature. Explain why inconsistency is monotonic.
