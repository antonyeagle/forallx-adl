...
\paragraph{Conjunction Introduction, p.\ \pageref{conjint}}
\begin{proof}
	\have[m]{a}{\meta{A}}
	\have[n]{b}{\meta{B}}
...
\paragraph{Conjunction Elimination, p.\ \pageref{conjelim}}
\begin{proof}
...
\paragraph{Conditional Introduction, p.\ \pageref{condint}}
\begin{proof}
	\open
		\hypo[i]{a}{\meta{A}}
		\have[j]{b}{\meta{B}}
...
\paragraph{Conditional Elimination, p.\ \pageref{condelim}}
\begin{proof}
...
\paragraph{Negation Introduction, p.\ \pageref{negint}}
...
\paragraph{Negation Elimination, p.\ \pageref{negelim}}
\begin{proof}
\open
	\hypo[i]{a}{\neg\meta{A}}
	\have[j]{b}{\meta{B}}
...
\paragraph{Disjunction Introduction, p.\ \pageref{disjint}}
...
\paragraph{Disjunction Elimination, p.\ \pageref{disjelim}}
\begin{proof}
...
\paragraph{Biconditional Introduction, p.\ \pageref{biint}}
\begin{proof}
	\open
		\hypo[i]{a1}{\meta{A}} 
		\have[j]{b1}{\meta{B}}
...
\paragraph{Biconditional Elimination, p.\ \pageref{bielim}}
\begin{proof}
