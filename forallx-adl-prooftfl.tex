...
\emph{We have now explained all of the basic rules for the proof system for \TFL.} Let's return to some of the arguments from §\ref{c:ass} with which we began our exploration of this system, to see how they can be proved.
...
Figure \ref{fig:vi} shows a long proof involving most of our rules in action. \begin{figure}
	\begin{proof}
	\open
