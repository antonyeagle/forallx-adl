...
This structure establishes a nice relationship between proofs and arguments. \factoidbox{A given proof  is a \define{proof of an argument} $\meta{A}_{1} … \meta{A}_{n} \ttherefore \meta{C}$ iff \begin{enumerate}
